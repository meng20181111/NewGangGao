...
public class SessionManager {
	...
	public enum Key{
		...
		,FOOTMARKTIME("footmarktime"),ORDER("ORDER"),YINGLIORDER("YLORDER"),REDIRECTPARAMETER("redirectParameter")
		,TENCENTINFO("tencentinfo"),MARKETNUMBER("makretnumber"),USERPARAM("userparam"),USERPARAM_h("userparam_h")
		,DIANYAN("dianyuan");
